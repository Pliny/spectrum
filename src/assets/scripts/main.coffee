...
$(document).on('ready', () ->
  ...
  $(document).on('click', '#new-function', () ->
    ...
    $('#sinusoids').append(
     '<div data-idx="'+ sIdx++ + '" class="sinusoid"><div class="row"><div class="col-xs-1"><input type="text" value="1" data-for=".amp-slider" class="form-control knobs amplitude"></div><div class="col-xs-1"><input type="text" value="2" data-for=".freq-slider" class="form-control knobs freq"></div><div class="col-xs-1"><input type="text" value="0" data-for=".phase-slider" class="form-control knobs phase"></div><div class="col-xs-1"><input type="text" value="0" data-for=".shift-slider" class="form-control knobs shift"></div><div class="col-xs-1"><a id="new-function"><span class="glyphicon glyphicon-plus"></span></a></div></div><div class="row"><div class="col-xs-1"><input type="range" min="0" max="10" step="0.5" data-for=".amplitude" class="form-control slider amp-slider"></div><div class="col-xs-1"><input type="range" min="0" max="64" step="0.5" data-for=".freq" class="form-control slider freq-slider"></div><div class="col-xs-1"><input type="range" min="0" max="6.2857142857" step="0.4" data-for=".phase" class="form-control slider phase-slider"></div><div class="col-xs-1"><input type="range" min="-3" max="3" step="0.25" data-for=".shift" class="form-control slider shift-slider"></div></div></div></div>'
    )
  )
